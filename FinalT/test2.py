...
def create_graph(): # สร้างกราฟ
    ...
    edges = [(1,2,1),(1,3,1),(1,4,1),(1,5,1),(2,3,1),(2,4,1),(2,5,1),(3,4,1),(3,5,1),(4,5,1),#(โหนดเริ่มต้น, โหนดปลาย, ระยะทาง)
             (4,6,1),(4,7,1),(5,7,1),(5,8,1),(6,7,1),(6,9,1),(7,8,1),(7,9,1),(7,10,1),(8,10,1),(9,10,1)] # การเชื่อมกันของแต่ละโหนด 
...
def draw_graph(G, node, colors, shortest_path=None):
    ...
    nx.draw_networkx_edge_labels(G, edge_labels=edge_labels, font_size=8)
...
def insert_node(G, node, colors, locate_add_edge, distance):
    ...
    G.add_edge(name, locate_add_edge,distance) # เพิ่มเส้นเชื่อมในกราฟ
...
if __name__ == "__main__":
    ...
    while True:  
        ...
        if menu == 1:
            ...
            distance = int(input("Enter distance : ")) # รับค่าระยะทาง
            insert_node(G, node, colors, locate_add_edge, distance) # เพิ่มโหนด
